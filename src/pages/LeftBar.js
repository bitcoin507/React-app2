...
const LeftBar = () => {
  ...
  const WebList = () => (
    <div id="projects">
      <a href="https://bitcoin507.github.io/Project-0/" target="#"> 
        <div className="ml-12 flex items-center hover:cursor-pointer hover:bg-opacity-80 hover:bg-[#2b2a2a] w-60">
         
          <p>Project-0</p>
        </div>
      </a>
      <a href="https://bitcoin507.github.io/Weather-API/" target="#"> 
        <div className="ml-12 flex items-center hover:cursor-pointer hover:bg-opacity-80 hover:bg-[#2b2a2a] w-60">
         
          <p>Weather API</p>
        </div>
      </a>
      <a href="https://bitcoin507.github.io/Day_Planner/ "target="#">
      ...
      <a href="https://bitcoin507.github.io/Code-Quiz/ "target="#">
      ...
      <div>
        ...
        <div className="absolute inset-x-0 bottom-10 ">
          <div className="flex px-6 space-x-7">
            <a href="https://github.com/bitcoin507"target="#">
              <img
                src={GitLogo}
                alt="Git Logo"
            ...
            <a href="https://www.linkedin.com/in/craig-henderson-5a7509bb/"target="#">
              <img
                src={LinkedinLogo}
                alt="Linkedin Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a  href="mailto:lionwolfgroup@gmail.com">
              <img
                src={MailLogo}
                alt="Mail Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
