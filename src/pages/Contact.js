  ...
  return (
    <div id="Contact" className="pb-72 mt-36">
      ...
      <div className="text-[#a2aabc] text-lg mt-5 mx-12 lg:mx-60 flex flex-col items-center text-justify">
        <code>
          Please feel free to contact me if you would like to chat about business or anything related
          to fintech; crypto; coding or just to say hi! Just click the "contact me" button below!
        </code>
